...
(DPIRD)](https://www.dpird.wa.gov.au/online-tools/apis/) and the [Scientific
Information for Land Owners (SILO)
API](https://www.longpaddock.qld.gov.au/silo/) endpoints and the
...
2.0](https://www.dpird.wa.gov.au/online-tools/apis/) Open API initiative.
...
[DPIRD](https://www.dpird.wa.gov.au/online-tools/apis/api-terms-and-conditions/) and
