...
hobart_daily
#>          date min_temperature max_temperature total_precipitation avg_wind_speed
#>        <Date>           <num>           <num>               <num>          <num>
#> 1: 2026-02-06            12.7            18.1                 0.0       4.452381
#> 2: 2026-02-07            13.7            20.7                 0.0       4.095833
#> 3: 2026-02-08            14.6            18.6                 2.0       4.126316
#> 4: 2026-02-09            14.0            23.2                 0.1       1.575000
#> 5: 2026-02-10            13.4            20.3                 0.4       1.775000
#> 6: 2026-02-11            15.0            20.2                 0.2       2.600000
#> 7: 2026-02-12            11.3            22.4                 0.5       5.150000
#>    max_wind_speed avg_relative_humidity avg_pressure avg_cloud_fraction
#>             <num>                 <num>        <num>              <num>
#> 1:            6.1              61.71429     1015.738           96.99524
#> 2:            5.9              66.65000     1013.958           92.57917
#> 3:            6.0              85.05263     1018.721          100.00000
#> 4:            2.9              69.22500     1014.350           46.10000
#> 5:            3.3              81.15000     1013.625           95.10000
#> 6:            3.8              83.75000     1009.800           81.45000
#> 7:            5.8              62.77500      995.050           60.35000
#>    dominant_weather_symbol
#>                     <char>
#> 1:                  cloudy
#> 2:                  cloudy
#> 3:               lightrain
...
#>  1: 2026-01-29     15.8     28.4           0.0 SILO (historical)
#>  2: 2026-01-30     16.1     28.5           0.0 SILO (historical)
#>  3: 2026-01-31     18.3     28.4           0.0 SILO (historical)
#>  4: 2026-02-01     17.3     34.3           0.0 SILO (historical)
#>  5: 2026-02-02     20.8     30.0           0.0 SILO (historical)
#>  6: 2026-02-03     15.7     25.8           0.0 SILO (historical)
#>  7: 2026-02-04     14.8     27.4           0.0 SILO (historical)
#>  8: 2026-02-06     15.6     28.7           0.0 met.no (forecast)
#>  9: 2026-02-07     15.7     28.3           0.0 met.no (forecast)
#> 10: 2026-02-08     15.8     27.8           0.2 met.no (forecast)
#> 11: 2026-02-09     17.7     28.2           1.0 met.no (forecast)
#> 12: 2026-02-10     19.6     27.5           1.7 met.no (forecast)
#> 13: 2026-02-11     19.6     27.3          30.0 met.no (forecast)
#> 14: 2026-02-12     21.4     30.5           1.1 met.no (forecast)
#> 15: 2026-02-13     20.9     30.8          11.2 met.no (forecast)
#> 16: 2026-02-14     18.1     23.1          33.5 met.no (forecast)
```
...
#>           date min_temp max_temp precipitation       data_source
#>         <Date>    <num>    <num>         <num>            <char>
#>  1: 2026-01-22     20.3     40.8             0  DPIRD (observed)
#>  2: 2026-01-23     16.7     31.6             0  DPIRD (observed)
#>  3: 2026-01-24     15.2     34.9             0  DPIRD (observed)
#>  4: 2026-01-25     14.1     30.3             0  DPIRD (observed)
#>  5: 2026-01-26     16.7     27.5             0  DPIRD (observed)
#>  6: 2026-01-27     11.8     29.5             0  DPIRD (observed)
#>  7: 2026-01-28     13.9     33.5             0  DPIRD (observed)
#>  8: 2026-01-29     15.7     38.5             0  DPIRD (observed)
#>  9: 2026-01-30     19.9     41.9             0  DPIRD (observed)
#> 10: 2026-01-31     18.8     37.2             0  DPIRD (observed)
#> 11: 2026-02-01     18.0     39.0             0  DPIRD (observed)
#> 12: 2026-02-02     21.6     42.2             0  DPIRD (observed)
#> 13: 2026-02-03     21.7     37.6             0  DPIRD (observed)
#> 14: 2026-02-04     16.1     32.1             0  DPIRD (observed)
#> 15: 2026-02-06     17.1     32.7             0 met.no (forecast)
#> 16: 2026-02-07     18.2     35.9             0 met.no (forecast)
#> 17: 2026-02-08     20.7     35.9             0 met.no (forecast)
#> 18: 2026-02-09     22.6     37.2             0 met.no (forecast)
#> 19: 2026-02-10     25.5     41.5             0 met.no (forecast)
#> 20: 2026-02-11     17.1     28.3             0 met.no (forecast)
#> 21: 2026-02-12     17.8     29.7             0 met.no (forecast)
#>           date min_temp max_temp precipitation       data_source
#>         <Date>    <num>    <num>         <num>            <char>
```
...
#>         <Date>    <num>         <num>              <num>
#>  1: 2026-01-22     32.9          39.2               39.2
#>  2: 2026-01-23     35.1           0.0               39.2
#>  3: 2026-01-24     33.8           0.0               39.2
#>  4: 2026-01-25     35.3           0.0               39.2
#>  5: 2026-01-26     34.8           0.0               39.2
#>  6: 2026-01-27     36.2           0.0               39.2
#>  7: 2026-01-28     35.8           0.0               39.2
#>  8: 2026-01-29     34.9           0.0               39.2
#>  9: 2026-01-30     33.8           0.0               39.2
#> 10: 2026-01-31     35.5           0.0               39.2
#> 11: 2026-02-01     37.6           0.0               39.2
#> 12: 2026-02-02     39.0           0.0               39.2
#> 13: 2026-02-03     30.3           1.3               40.5
#> 14: 2026-02-04     33.0           0.0               40.5
#> 15: 2026-02-06     32.9           0.0               40.5
#> 16: 2026-02-07     33.8           0.0               40.5
#> 17: 2026-02-08     32.8           0.6               41.1
#> 18: 2026-02-09     33.1           0.3               41.4
#> 19: 2026-02-10     34.0           1.2               42.6
#> 20: 2026-02-11     35.7           6.1               48.7
#> 21: 2026-02-12     35.6          35.6               84.3
#> 22: 2026-02-13     30.3           5.0               89.3
#> 23: 2026-02-14     32.6          18.1              107.4
#>           date max_temp precipitation cumulative_balance
#>         <Date>    <num>         <num>              <num>
```
...
#>  $ date                   : Date, format: "2026-02-06" "2026-02-07" ...
#>  $ min_temperature        : num  20.8 22 23.4 22 21.5 20.6 23.6 21.3 20.8 20.7
#>  $ max_temperature        : num  31.4 27.3 28.2 25 23.1 24.5 27.1 24.3 22.2 23.1
#>  $ total_precipitation    : num  0 0 0 11.8 24.6 0.1 0 5.6 0.2 1.3
#>  $ avg_wind_speed         : num  7.85 4.29 4.75 2.75 2.8 ...
#>  $ max_wind_speed         : num  11.3 8.6 6.3 4.1 3.8 4.1 5.6 7 5.1 5.5
#>  $ avg_relative_humidity  : num  75.3 82.3 80.9 72 92.9 ...
#>  $ avg_pressure           : num  1017 1016 1016 1016 1011 ...
#>  $ avg_cloud_fraction     : num  41.1 54 98.5 99.8 96.3 ...
#>  $ dominant_weather_symbol: chr  "cloudy" "fog" "partlycloudy_day" "heavyrain" ...
...
print(symbols_48h)
#> [1] "partlycloudy_day" "fair_day"         "clearsky_day"     "clearsky_night"
...
#>        <Date>                  <char>
#> 1: 2026-02-06        partlycloudy_day
#> 2: 2026-02-07            clearsky_day
#> 3: 2026-02-08      partlycloudy_night
#> 4: 2026-02-09        partlycloudy_day
#> 5: 2026-02-10      partlycloudy_night
```
