...
#>             <fctr>              <POSc>           <num>             <num>           <lgcl>            <int>    <int>     <num>
#>    1:           NO 2024-06-04 16:43:00            19.9              62.6               NA               27        0      12.6
#>    2:           NO 2024-06-04 16:44:00            19.9              62.4               NA               26        0      12.5
#>    3:           NO 2024-06-04 16:45:00            19.9              62.6               NA               25        0      12.6
#>    4:           NO 2024-06-04 16:46:00            19.9              64.0               NA               24        0      12.9
#>    5:           NO 2024-06-04 16:47:00            19.9              63.2               NA               23        0      12.7
#>   ---                                                                                                                        
#> 1429:           NO 2024-06-05 16:31:00            22.1              40.0               NA              103        0       7.9
#> 1430:           NO 2024-06-05 16:32:00            22.0              40.5               NA              100        0       8.0
#> 1431:           NO 2024-06-05 16:33:00            22.0              41.6               NA               98        0       8.4
#> 1432:           NO 2024-06-05 16:34:00            22.0              40.6               NA               95        0       8.0
#> 1433:           NO 2024-06-05 16:35:00            22.0              41.6               NA               92        0       8.4
#>       wet_bulb wind_height wind_avg_speed wind_avg_direction_compass_point wind_avg_direction_degrees wind_min_speed
#>          <num>       <int>          <num>                           <char>                      <int>          <num>
#>    1:     16.0           3           0.14                              WNW                        296          0.144
#>    2:     15.9           3           0.14                               NW                        304          0.144
#>    3:     16.0           3           0.14                               NW                        304          0.144
#>    4:     16.1           3           0.14                               NW                        304          0.144
#>    5:     16.0           3           0.65                               NW                        304          0.144
#>   ---                                                                                                               
#> 1429:     14.7           3           9.22                                N                        356          7.200
#> 1430:     14.7           3           8.71                              NNW                        348          5.688
#> 1431:     14.9           3           6.70                                N                        355          5.184
#> 1432:     14.7           3           7.20                              NNW                        348          4.680
#> 1433:     14.9           3           8.21                              NNW                        347          6.192
#>       wind_max_speed
#>                <num>
#>    1:           1.15
#>    2:           1.15
...
#>    ---                                                                                                  
#> 42526:           BI        Binnu  114.6958  -28.051  2024     6     4    22 2024-06-04 22:00:00        0
#> 42527:           BI        Binnu  114.6958  -28.051  2024     6     4    23 2024-06-04 23:00:00        0
#> 42528:           BI        Binnu  114.6958  -28.051  2024     6     4    23 2024-06-04 23:00:00        0
#> 42529:           BI        Binnu  114.6958  -28.051  2024     6     5     0 2024-06-05 00:00:00        0
#> 42530:           BI        Binnu  114.6958  -28.051  2024     6     5     0 2024-06-05 00:00:00        0
...
#>     5:                              ENE                         58           0.00           3                                N
#>    ---                                                                                                                        
#> 42526:                              WNW                        286          55.23          10                              WNW
#> 42527:                               NW                        313          43.20           3                               NW
#> 42528:                               NW                        312          57.27          10                               NW
#> 42529:                               NW                        317          44.32           3                               NW
#> 42530:                               NW                        315          58.52          10                               NW
...
#>    ---                                                              
#> 42526:                        282          78.37 2023-09-13 14:25:00
#> 42527:                        318          72.94 2023-09-13 12:39:00
#> 42528:                        314          90.58 2023-09-13 12:24:00
#> 42529:                        311          73.76 2023-09-13 11:40:00
#> 42530:                        311          91.19 2023-09-13 11:34:00
```
...
#> latitude = -28.051 
#> longitude = 114.69575 
#> tav = 20.5987671232877 (oC) ! calculated annual average ambient temperature 2024-06-05 16:43:27.097094 
#> amp = 15.3 !calculated with the apsimx R package: 2024-06-05 16:43:27.099872 
...
<img src="vignettes/view sw_ag_region-1.png" alt="plot of chunk view sw_ag_region"  />
...
#>          <fctr>       <char>  <int>     <num>      <num>        <num>        <num>                <num>                 <num>
#> 1:        WS001     Westonia    100      98.9       99.5         87.5         99.6                 99.9                  99.9
#>    last14_days_since9_am last14_days_since12_am month_to_date_to9_am month_to_date_since12_am year_to_date_to9_am
#>                    <int>                  <int>                <num>                    <num>               <int>
#> 1:                   100                    100                 99.9                     99.9                 100
