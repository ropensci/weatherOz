...
#>    1:           NO 2024-08-02 15:43:00            15.1              55.2             17.9              220
#>    2:           NO 2024-08-02 15:44:00            15.1              53.4             17.9              259
#>    3:           NO 2024-08-02 15:45:00            15.1              53.7             17.8              275
#>    4:           NO 2024-08-02 15:46:00            15.3              53.6             17.8              270
#>    5:           NO 2024-08-02 15:47:00            15.4              56.2             17.8              234
#>   ---                                                                                                     
#> 1429:           NO 2024-08-03 15:31:00            17.2              43.2             18.5              382
#> 1430:           NO 2024-08-03 15:32:00            17.3              45.2             18.5              378
#> 1431:           NO 2024-08-03 15:33:00            17.4              45.5             18.5              374
#> 1432:           NO 2024-08-03 15:34:00            17.4              44.5             18.4              371
#> 1433:           NO 2024-08-03 15:35:00            17.2              43.8             18.4              369
#>       rainfall dew_point wet_bulb wind_height wind_avg_speed wind_avg_direction_compass_point
#>          <int>     <num>    <num>       <int>          <num>                           <char>
#>    1:        0       6.2     10.9           3           0.65                              SSE
#>    2:        0       5.7     10.7           3           0.14                              SSE
#>    3:        0       5.8     10.8           3           0.14                              SSE
#>    4:        0       5.9     10.9           3           0.14                                S
#>    5:        0       6.7     11.3           3           0.14                                S
#>   ---                                                                                        
#> 1429:        0       4.6     11.3           3           3.67                               SE
#> 1430:        0       5.3     11.6           3           2.66                                E
#> 1431:        0       5.5     11.7           3           1.66                              ESE
#> 1432:        0       5.2     11.6           3           4.18                              SSE
#> 1433:        0       4.8     11.3           3           3.17                              ENE
...
#> 8:        CL001        Capel  115.6376 -33.61576  2024    471.8
```
...
#> 92:        CL001        Capel  115.6376 -33.61576  2024     8 2024-08-01     24.0
#>     station_code station_name longitude  latitude  year month       date rainfall
```
...
#>    1:           3                              NNE                         31          17.57 2018-07-17 11:51:00
#>    2:          10                              ESE                        121          23.18 2017-07-30 11:38:00
#>    3:           3                               NE                         41          21.78 2017-08-10 13:29:00
#>    4:          10                                N                          1          19.55 2018-07-17 12:16:00
#>    5:           3                              WSW                        247          18.40 2017-06-14 09:05:00
#>   ---                                                                                                           
#> 1456:          10                               SE                        134          60.91 2017-02-09 15:56:00
#> 1457:           3                              ESE                        105          62.03 2018-01-14 22:55:00
#> 1458:          10                              ESE                        113          69.77 2018-01-14 22:45:00
#> 1459:           3                              SSE                        163          58.64 2017-02-08 09:12:00
#> 1460:          10                              SSE                        167          64.40 2017-02-08 04:48:00
```
...
#>    ---                                                                                                  
#> 45358:           BI        Binnu  114.6958  -28.051  2024     8     2    22 2024-08-02 22:00:00        0
#> 45359:           BI        Binnu  114.6958  -28.051  2024     8     2    23 2024-08-02 23:00:00        0
#> 45360:           BI        Binnu  114.6958  -28.051  2024     8     2    23 2024-08-02 23:00:00        0
#> 45361:           BI        Binnu  114.6958  -28.051  2024     8     3     0 2024-08-03 00:00:00        0
#> 45362:           BI        Binnu  114.6958  -28.051  2024     8     3     0 2024-08-03 00:00:00        0
...
#>     5:                              ENE                         58           0.00           3
#>    ---                                                                                       
#> 45358:                              WNW                        286          55.23          10
#> 45359:                               NW                        313          43.20           3
#> 45360:                               NW                        312          57.27          10
#> 45361:                               NW                        317          44.32           3
#> 45362:                               NW                        315          58.52          10
...
#>    ---                                                                                               
#> 45358:                              WNW                        282          78.37 2023-09-13 14:25:00
#> 45359:                               NW                        318          72.94 2023-09-13 12:39:00
#> 45360:                               NW                        314          90.58 2023-09-13 12:24:00
#> 45361:                               NW                        311          73.76 2023-09-13 11:40:00
#> 45362:                               NW                        311          91.19 2023-09-13 11:34:00
```
...
#> latitude = -28.051 
#> longitude = 114.69575 
#> tav = 20.5987671232877 (oC) ! calculated annual average ambient temperature 2024-08-03 15:44:03.691831 
#> amp = 15.3 !calculated with the apsimx R package: 2024-08-03 15:44:03.698107 
...
#> 5:         BCAA    DBCA-A Portable  116.2561 -31.84220     WA    267
#>                                                                   owner distance_km
#>                                                                  <char>       <num>
...
#> 5:   WA Department of Biodiversity, Conservation and Attractions (DBCA)       47.78
```
...
#> 5:   WA Department of Biodiversity, Conservation and Attractions (DBCA)       44.74
```
...
#> 23:         BCAA    DBCA-A Portable  116.2561 -31.84220     WA    267
...
#> 21:                                                                  BOM   46.778842
#> 22:                                                                  BOM   47.759247
#> 23:   WA Department of Biodiversity, Conservation and Attractions (DBCA)   47.780000
#> 24:                                                                  BOM   49.440793
#>                                                                    owner distance_km
```
...
#>    1:       009804                     Adina 1969-01-01 2024-08-03 -33.88110  122.2167     WA     60
#>    2:       008000                     Ajana 1917-01-01 2024-08-03 -27.96070  114.6336     WA    210
#>    3:       009500                    Albany 1877-01-01 2024-08-03 -35.02890  117.8808     WA      3
...
#>   ---                                                                                               
#> 1034:       008146                  Ytiniche 1913-01-01 2024-08-03 -30.07060  116.2092     WA    300
#> 1035:       008147                      Yuna 1909-01-01 2024-08-03 -28.32500  114.9589     WA    270
#> 1036:        YU001                      Yuna 2012-06-21 2024-08-03 -28.33763  114.9898     WA    329
#> 1037:        YU002                   Yuna NE 2016-03-24 2024-08-03 -28.20032  115.2616     WA    267
#> 1038:        YU003                Yuna North 2018-08-08 2024-08-03 -28.12086  114.9626     WA    264
#>                                                                     source status   wmo
#>                                                                     <char> <char> <num>
...
#> 1:        WS001     Westonia    100      98.8       99.5         87.5         99.6                 99.9
...
#>   1:        AN001    Allanooka 2012-06-19 2024-08-03 -29.06361  114.9972     WA    131
#>   2:        AM001       Amelup 2019-10-09 2024-08-03 -34.27083  118.2685     WA    200
#>   3:        SH002      Babakin 2016-06-22 2024-08-03 -32.12548  118.0041     WA    313
#>   4:           BA  Badgingarra 2008-11-19 2024-08-03 -30.33805  115.5395     WA    284
#>   5:        BP001     Balingup 2014-10-24 2024-08-03 -33.79620  116.0640     WA    227
#>  ---                                                                                  
#> 219:           YS      Yilgarn 2008-11-01 2024-08-03 -31.91562  119.2561     WA    468
#> 220:        YE001    York East 2013-11-08 2024-08-03 -31.83588  116.9211     WA    229
#> 221:        YU001         Yuna 2012-06-21 2024-08-03 -28.33763  114.9898     WA    329
#> 222:        YU002      Yuna NE 2016-03-24 2024-08-03 -28.20032  115.2616     WA    267
#> 223:        YU003   Yuna North 2018-08-08 2024-08-03 -28.12086  114.9626     WA    264
#>                                                                    source status    wmo
#>                                                                    <char> <char> <lgcl>
...
#>   5:        BP001     Balingup 2014-10-24 2024-08-03 -33.79620  116.0640     WA    227
#>  ---                                                                                  
#> 234:           YS      Yilgarn 2008-11-01 2024-08-03 -31.91562  119.2561     WA    468
#> 235:        YE001    York East 2013-11-08 2024-08-03 -31.83588  116.9211     WA    229
#> 236:        YU001         Yuna 2012-06-21 2024-08-03 -28.33763  114.9898     WA    329
#> 237:        YU002      Yuna NE 2016-03-24 2024-08-03 -28.20032  115.2616     WA    267
#> 238:        YU003   Yuna North 2018-08-08 2024-08-03 -28.12086  114.9626     WA    264
