...
#>             <fctr>              <POSc>           <num>             <num>
#>    1:           NO 2024-05-19 18:42:00            17.3              30.4
#>    2:           NO 2024-05-19 18:43:00            17.2              30.6
#>    3:           NO 2024-05-19 18:44:00            17.1              30.7
#>    4:           NO 2024-05-19 18:45:00            17.0              30.8
#>    5:           NO 2024-05-19 18:46:00            16.9              31.1
#>   ---                                                                   
#> 1430:           NO 2024-05-20 18:31:00            18.4              34.0
#> 1431:           NO 2024-05-20 18:32:00            18.6              33.6
#> 1432:           NO 2024-05-20 18:33:00            18.7              33.4
#> 1433:           NO 2024-05-20 18:34:00            18.8              33.2
#> 1434:           NO 2024-05-20 18:35:00            18.9              33.1
#>       soil_temperature solar_irradiance rainfall dew_point wet_bulb wind_height
#>                  <num>            <int>    <int>     <num>    <num>       <int>
#>    1:             22.8                0        0      -0.2      9.5           3
#>    2:             22.8                0        0      -0.2      9.5           3
#>    3:             22.8                0        0      -0.3      9.4           3
#>    4:             22.8                0        0      -0.3      9.4           3
#>    5:             22.7                0        0      -0.3      9.3           3
#>   ---                                                                          
#> 1430:             22.1                0        0       2.3     10.9           3
#> 1431:             22.1                0        0       2.3     11.0           3
#> 1432:             22.0                0        0       2.3     11.1           3
#> 1433:             22.0                0        0       2.3     11.1           3
#> 1434:             22.0                0        0       2.3     11.2           3
...
#>    ---                                                                     
#> 41758:           BI        Binnu  114.6958  -28.051  2024     5    19    22
#> 41759:           BI        Binnu  114.6958  -28.051  2024     5    19    23
#> 41760:           BI        Binnu  114.6958  -28.051  2024     5    19    23
#> 41761:           BI        Binnu  114.6958  -28.051  2024     5    20     0
#> 41762:           BI        Binnu  114.6958  -28.051  2024     5    20     0
...
#>    ---                                                              
#> 41758: 2024-05-19 22:00:00        0                              WNW
#> 41759: 2024-05-19 23:00:00        0                               NW
#> 41760: 2024-05-19 23:00:00        0                               NW
#> 41761: 2024-05-20 00:00:00        0                               NW
#> 41762: 2024-05-20 00:00:00        0                               NW
...
#>     2:           1.55 2023-04-08 00:58:00
#>     3:           0.00 2022-07-23 01:01:00
#>     4:           2.52 2023-04-08 02:00:00
#>     5:           0.00 2023-02-04 22:01:00
#>    ---                                   
#> 41758:          78.37 2023-09-13 14:25:00
#> 41759:          72.94 2023-09-13 12:39:00
#> 41760:          90.58 2023-09-13 12:24:00
#> 41761:          73.76 2023-09-13 11:40:00
#> 41762:          91.19 2023-09-13 11:34:00
```
...
#> Warning in amp_apsim_met(x): Year: 2022 was not used for calculating 'amp'
#> because less than 300 days were present
#> Warning in amp_apsim_met(met): Year: 2022 was not used for calculating 'amp'
#> because less than 300 days were present
#> weather.met.met 
#> site = Binnu 
#> latitude = -28.051 
#> longitude = 114.69575 
#> tav = 16.78 (oC) ! calculated annual average ambient temperature 2024-05-20 18:45:24.347571 
#> amp = 0 !calculated with the apsimx R package: 2024-05-20 18:45:24.35918 
...
#>  from coordinates 116.694194 and -31.651611 (lon/lat).
#>    station_code       station_name longitude  latitude  state elev_m
#>          <fctr>             <char>     <num>     <num> <char>  <int>
#> 1:           NO            Northam  116.6942 -31.65161     WA    163
#> 2:           MK             Muresk  116.6913 -31.72772     WA    251
...
#>   1:        AM001       Amelup 2019-10-09 2024-05-20 -34.27083  118.2685     WA
#>   2:        SH002      Babakin 2016-06-22 2024-05-20 -32.12548  118.0041     WA
#>   3:           BA  Badgingarra 2008-11-19 2024-05-20 -30.33805  115.5395     WA
#>   4:        BP001     Balingup 2014-10-24 2024-05-20 -33.79620  116.0640     WA
#>   5:        BE001       Beacon 2012-06-27 2024-05-20 -30.47333  117.8811     WA
#>  ---                                                                           
#> 217:           YS      Yilgarn 2008-11-01 2024-05-20 -31.91562  119.2561     WA
#> 218:        YE001    York East 2013-11-08 2024-05-20 -31.83588  116.9211     WA
#> 219:        YU001         Yuna 2012-06-21 2024-05-20 -28.33763  114.9898     WA
#> 220:        YU002      Yuna NE 2016-03-24 2024-05-20 -28.20032  115.2616     WA
#> 221:        YU003   Yuna North 2018-08-08 2024-05-20 -28.12086  114.9626     WA
#>      elev_m
#>       <num>
#>   1:    200
#>   2:    313
...
#>  ---                                                                     
#> 217: WA Department of Primary Industries and Regional Development (DPIRD)
#> 218: WA Department of Primary Industries and Regional Development (DPIRD)
#> 219: WA Department of Primary Industries and Regional Development (DPIRD)
...
#>   1:        AN001    Allanooka 2012-06-19 2024-05-20 -29.06361  114.9972     WA
#>   2:        AM001       Amelup 2019-10-09 2024-05-20 -34.27083  118.2685     WA
#>   3:        SH002      Babakin 2016-06-22 2024-05-20 -32.12548  118.0041     WA
#>   4:           BA  Badgingarra 2008-11-19 2024-05-20 -30.33805  115.5395     WA
#>   5:        BP001     Balingup 2014-10-24 2024-05-20 -33.79620  116.0640     WA
#>  ---                                                                           
#> 226:           YS      Yilgarn 2008-11-01 2024-05-20 -31.91562  119.2561     WA
#> 227:        YE001    York East 2013-11-08 2024-05-20 -31.83588  116.9211     WA
#> 228:        YU001         Yuna 2012-06-21 2024-05-20 -28.33763  114.9898     WA
#> 229:        YU002      Yuna NE 2016-03-24 2024-05-20 -28.20032  115.2616     WA
#> 230:        YU003   Yuna North 2018-08-08 2024-05-20 -28.12086  114.9626     WA
#>      elev_m
#>       <int>
#>   1:    131
#>   2:    200
...
#>   5:        BP001     Balingup 2014-10-24 2024-05-20 -33.79620  116.0640     WA
#>  ---                                                                           
#> 234:           YS      Yilgarn 2008-11-01 2024-05-20 -31.91562  119.2561     WA
#> 235:        YE001    York East 2013-11-08 2024-05-20 -31.83588  116.9211     WA
#> 236:        YU001         Yuna 2012-06-21 2024-05-20 -28.33763  114.9898     WA
#> 237:        YU002      Yuna NE 2016-03-24 2024-05-20 -28.20032  115.2616     WA
#> 238:        YU003   Yuna North 2018-08-08 2024-05-20 -28.12086  114.9626     WA
#>      elev_m
#>       <int>
#>   1:    131
#>   2:    200
