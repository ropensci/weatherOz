...
#>    1:           NO 2024-07-04 18:56:00            10.0              82.4             12.4                0
#>    2:           NO 2024-07-04 18:57:00            10.0              82.6             12.4                0
#>    3:           NO 2024-07-04 18:58:00            10.0              82.7             12.3                0
#>    4:           NO 2024-07-04 18:59:00            10.0              82.9             12.3                0
#>    5:           NO 2024-07-04 19:00:00            10.0              83.1             12.3                0
#>   ---                                                                                                     
#> 1431:           NO 2024-07-05 18:46:00             9.7              58.7             12.4                0
#> 1432:           NO 2024-07-05 18:47:00             9.6              59.0             12.4                0
#> 1433:           NO 2024-07-05 18:48:00             9.6              59.2             12.4                0
#> 1434:           NO 2024-07-05 18:49:00             9.6              59.5             12.4                0
#> 1435:           NO 2024-07-05 18:50:00             9.6              59.4             12.4                0
#>       rainfall dew_point wet_bulb wind_height wind_avg_speed wind_avg_direction_compass_point
#>          <num>     <num>    <num>       <int>          <num>                           <char>
#>    1:        0       7.1      8.7           3           0.14                                E
#>    2:        0       7.2      8.8           3           0.14                                E
#>    3:        0       7.2      8.8           3           0.14                                E
#>    4:        0       7.2      8.8           3           0.14                                E
#>    5:        0       7.3      8.8           3           0.14                                E
#>   ---                                                                                        
#> 1431:        0       2.0      6.5           3           2.16                               SE
#> 1432:        0       2.0      6.5           3           2.16                              SSE
#> 1433:        0       2.0      6.5           3           1.66                               SE
#> 1434:        0       2.1      6.5           3           1.66                              SSE
#> 1435:        0       2.1      6.5           3           1.66                               SE
...
#> 8:        CL001        Capel  115.6376 -33.61576  2024    273.2
```
...
#> 91:        CL001        Capel  115.6376 -33.61576  2024     7 2024-07-01      8.2
#>     station_code station_name longitude  latitude  year month       date rainfall
```
...
#>    ---                                                                                                  
#> 43966:           BI        Binnu  114.6958  -28.051  2024     7     4    22 2024-07-04 22:00:00        0
#> 43967:           BI        Binnu  114.6958  -28.051  2024     7     4    23 2024-07-04 23:00:00        0
#> 43968:           BI        Binnu  114.6958  -28.051  2024     7     4    23 2024-07-04 23:00:00        0
#> 43969:           BI        Binnu  114.6958  -28.051  2024     7     5     0 2024-07-05 00:00:00        0
#> 43970:           BI        Binnu  114.6958  -28.051  2024     7     5     0 2024-07-05 00:00:00        0
...
#>     5:                              ENE                         58           0.00           3
#>    ---                                                                                       
#> 43966:                              WNW                        286          55.23          10
#> 43967:                               NW                        313          43.20           3
#> 43968:                               NW                        312          57.27          10
#> 43969:                               NW                        317          44.32           3
#> 43970:                               NW                        315          58.52          10
...
#>    ---                                                                                               
#> 43966:                              WNW                        282          78.37 2023-09-13 14:25:00
#> 43967:                               NW                        318          72.94 2023-09-13 12:39:00
#> 43968:                               NW                        314          90.58 2023-09-13 12:24:00
#> 43969:                               NW                        311          73.76 2023-09-13 11:40:00
#> 43970:                               NW                        311          91.19 2023-09-13 11:34:00
```
...
#> latitude = -28.051 
#> longitude = 114.69575 
#> tav = 20.5987671232877 (oC) ! calculated annual average ambient temperature 2024-07-05 18:56:59.599763 
#> amp = 15.3 !calculated with the apsimx R package: 2024-07-05 18:56:59.604857 
...
#> 6:         BCAA    DBCA-A Portable  116.2560 -31.84210     WA    266
#>                                                                   owner distance_km
#>                                                                  <char>       <num>
...
#> 24:         BCAA    DBCA-A Portable  116.2560 -31.84210     WA    266
...
#>    1:       009804                     Adina 1969-01-01 2024-07-05 -33.88110  122.2167     WA     60
#>    2:       008000                     Ajana 1917-01-01 2024-07-05 -27.96070  114.6336     WA    210
#>    3:       009500                    Albany 1877-01-01 2024-07-05 -35.02890  117.8808     WA      3
...
#>   ---                                                                                               
#> 1034:       008146                  Ytiniche 1913-01-01 2024-07-05 -30.07060  116.2092     WA    300
#> 1035:       008147                      Yuna 1909-01-01 2024-07-05 -28.32500  114.9589     WA    270
#> 1036:        YU001                      Yuna 2012-06-21 2024-07-05 -28.33763  114.9898     WA    329
#> 1037:        YU002                   Yuna NE 2016-03-24 2024-07-05 -28.20032  115.2616     WA    267
#> 1038:        YU003                Yuna North 2018-08-08 2024-07-05 -28.12086  114.9626     WA    264
#>                                                                     source status   wmo
#>                                                                     <char> <char> <num>
...
#> 1:        WS001     Westonia    100      99.2       99.6         90.9         99.7                 99.9
...
#>   1:        AN001    Allanooka 2012-06-19 2024-07-05 -29.06361  114.9972     WA    131
#>   2:        AM001       Amelup 2019-10-09 2024-07-05 -34.27083  118.2685     WA    200
#>   3:        SH002      Babakin 2016-06-22 2024-07-05 -32.12548  118.0041     WA    313
#>   4:           BA  Badgingarra 2008-11-19 2024-07-05 -30.33805  115.5395     WA    284
#>   5:        BP001     Balingup 2014-10-24 2024-07-05 -33.79620  116.0640     WA    227
#>  ---                                                                                  
#> 227:           YS      Yilgarn 2008-11-01 2024-07-05 -31.91562  119.2561     WA    468
#> 228:        YE001    York East 2013-11-08 2024-07-05 -31.83588  116.9211     WA    229
#> 229:        YU001         Yuna 2012-06-21 2024-07-05 -28.33763  114.9898     WA    329
#> 230:        YU002      Yuna NE 2016-03-24 2024-07-05 -28.20032  115.2616     WA    267
#> 231:        YU003   Yuna North 2018-08-08 2024-07-05 -28.12086  114.9626     WA    264
#>                                                                    source status    wmo
#>                                                                    <char> <char> <lgcl>
...
#> 231: WA Department of Primary Industries and Regional Development (DPIRD)   open     NA
```
...
#>   5:        BP001     Balingup 2014-10-24 2024-07-05 -33.79620  116.0640     WA    227
#>  ---                                                                                  
#> 234:           YS      Yilgarn 2008-11-01 2024-07-05 -31.91562  119.2561     WA    468
#> 235:        YE001    York East 2013-11-08 2024-07-05 -31.83588  116.9211     WA    229
#> 236:        YU001         Yuna 2012-06-21 2024-07-05 -28.33763  114.9898     WA    329
#> 237:        YU002      Yuna NE 2016-03-24 2024-07-05 -28.20032  115.2616     WA    267
#> 238:        YU003   Yuna North 2018-08-08 2024-07-05 -28.12086  114.9626     WA    264
