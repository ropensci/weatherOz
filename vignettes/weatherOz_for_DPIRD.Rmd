...
#>    1:           NO 2024-06-04 17:57:00            18.3              72.5               NA
#>    2:           NO 2024-06-04 17:58:00            18.3              72.2               NA
#>    3:           NO 2024-06-04 17:59:00            18.2              72.1               NA
#>    4:           NO 2024-06-04 18:00:00            18.2              71.9               NA
#>    5:           NO 2024-06-04 18:01:00            18.2              71.7               NA
#>   ---                                                                                    
#> 1430:           NO 2024-06-05 17:46:00            18.7              52.2               NA
#> 1431:           NO 2024-06-05 17:47:00            18.7              51.7               NA
#> 1432:           NO 2024-06-05 17:48:00            18.7              52.0               NA
#> 1433:           NO 2024-06-05 17:49:00            18.6              52.2               NA
#> 1434:           NO 2024-06-05 17:50:00            18.6              52.7               NA
#>       solar_irradiance rainfall dew_point wet_bulb wind_height wind_avg_speed
#>                  <int>    <int>     <num>    <num>       <int>          <num>
#>    1:                0        0      13.3     15.6           3           0.14
#>    2:                0        0      13.2     15.6           3           0.14
#>    3:                0        0      13.1     15.5           3           0.14
#>    4:                0        0      13.1     15.5           3           0.14
#>    5:                0        0      13.0     15.5           3           0.14
#>   ---                                                                        
#> 1430:                0        0       8.7     13.7           3           0.14
#> 1431:                0        0       8.6     13.6           3           0.14
#> 1432:                0        0       8.7     13.6           3           0.14
#> 1433:                0        0       8.6     13.6           3           0.14
#> 1434:                0        0       8.8     13.6           3           0.14
#>       wind_avg_direction_compass_point wind_avg_direction_degrees wind_min_speed wind_max_speed
#>                                 <char>                      <int>          <num>          <num>
#>    1:                              NNW                        348          0.144           0.14
#>    2:                              NNW                        348          0.144           0.14
#>    3:                              NNW                        348          0.144           0.14
#>    4:                              NNW                        348          0.144           0.14
#>    5:                              NNW                        348          0.144           0.14
#>   ---                                                                                          
#> 1430:                               NE                         43          0.144           0.65
#> 1431:                               NE                         43          0.144           0.65
#> 1432:                               NE                         43          0.144           0.65
#> 1433:                               NE                         43          0.144           0.65
#> 1434:                               NE                         43          0.144           0.65
```
...
#> 8:        CL001        Capel  115.6376 -33.61576  2024    132.0
```
...
#> 90:        CL001        Capel  115.6376 -33.61576  2024     6 2024-06-01     69.2
#>     station_code station_name longitude  latitude  year month       date rainfall
```
...
#> Key: <station_code>
#>       station_code station_name longitude latitude  year month   day       date rainfall
#>             <fctr>       <char>     <num>    <num> <int> <int> <int>     <Date>    <num>
#>    1:           BI        Binnu  114.6958  -28.051  2017     1     1 2017-01-01        0
#>    2:           BI        Binnu  114.6958  -28.051  2017     1     1 2017-01-01        0
#>    3:           BI        Binnu  114.6958  -28.051  2017     1     2 2017-01-02        0
#>    4:           BI        Binnu  114.6958  -28.051  2017     1     2 2017-01-02        0
#>    5:           BI        Binnu  114.6958  -28.051  2017     1     3 2017-01-03        0
#>   ---                                                                                   
#> 1456:           BI        Binnu  114.6958  -28.051  2018    12    29 2018-12-29        0
#> 1457:           BI        Binnu  114.6958  -28.051  2018    12    30 2018-12-30        0
#> 1458:           BI        Binnu  114.6958  -28.051  2018    12    30 2018-12-30        0
#> 1459:           BI        Binnu  114.6958  -28.051  2018    12    31 2018-12-31        0
#> 1460:           BI        Binnu  114.6958  -28.051  2018    12    31 2018-12-31        0
#>       wind_avg_speed wind_height wind_max_direction_compass_point wind_max_direction_degrees
#>                <num>       <int>                           <char>                      <int>
#>    1:           4.28           3                              NNE                         31
#>    2:           6.85          10                              ESE                        121
#>    3:           4.53           3                               NE                         41
...
#>    5:           4.74           3                              WSW                        247
#>   ---                                                                                       
#> 1456:          35.63          10                               SE                        134
#> 1457:          29.19           3                              ESE                        105
#> 1458:          36.70          10                              ESE                        113
#> 1459:          32.52           3                              SSE                        163
#> 1460:          41.51          10                              SSE                        167
...
#>    ---                                                                                         
#> 42526:           BI        Binnu  114.6958  -28.051  2024     6     4    22 2024-06-04 22:00:00
#> 42527:           BI        Binnu  114.6958  -28.051  2024     6     4    23 2024-06-04 23:00:00
#> 42528:           BI        Binnu  114.6958  -28.051  2024     6     4    23 2024-06-04 23:00:00
#> 42529:           BI        Binnu  114.6958  -28.051  2024     6     5     0 2024-06-05 00:00:00
#> 42530:           BI        Binnu  114.6958  -28.051  2024     6     5     0 2024-06-05 00:00:00
...
#>     5:        0                              ENE                         58           0.00           3
#>    ---                                                                                                
#> 42526:        0                              WNW                        286          55.23          10
#> 42527:        0                               NW                        313          43.20           3
#> 42528:        0                               NW                        312          57.27          10
#> 42529:        0                               NW                        317          44.32           3
#> 42530:        0                               NW                        315          58.52          10
...
#>    ---                                                                                               
#> 42526:                              WNW                        282          78.37 2023-09-13 14:25:00
#> 42527:                               NW                        318          72.94 2023-09-13 12:39:00
#> 42528:                               NW                        314          90.58 2023-09-13 12:24:00
#> 42529:                               NW                        311          73.76 2023-09-13 11:40:00
#> 42530:                               NW                        311          91.19 2023-09-13 11:34:00
```
...
#> latitude = -28.051 
#> longitude = 114.69575 
#> tav = 20.5987671232877 (oC) ! calculated annual average ambient temperature 2024-06-05 17:57:32.94957 
#> amp = 15.3 !calculated with the apsimx R package: 2024-06-05 17:57:32.954057 
...
<img src="view sw_ag_region-1.png" alt="plot of chunk view sw_ag_region"  />
<p class="caption">plot of chunk view sw_ag_region</p>
</div>
...
#>    1:       009804                     Adina 1969-01-01 2024-06-05 -33.88110  122.2167     WA     60
#>    2:       008000                     Ajana 1917-01-01 2024-06-05 -27.96070  114.6336     WA    210
#>    3:       009500                    Albany 1877-01-01 2024-06-05 -35.02890  117.8808     WA      3
...
#>   ---                                                                                               
#> 1034:       008146                  Ytiniche 1913-01-01 2024-06-05 -30.07060  116.2092     WA    300
#> 1035:       008147                      Yuna 1909-01-01 2024-06-05 -28.32500  114.9589     WA    270
#> 1036:        YU001                      Yuna 2012-06-21 2024-06-05 -28.33763  114.9898     WA    329
#> 1037:        YU002                   Yuna NE 2016-03-24 2024-06-05 -28.20032  115.2616     WA    267
#> 1038:        YU003                Yuna North 2018-08-08 2024-06-05 -28.12086  114.9626     WA    264
#>                                                                     source status   wmo
#>                                                                     <char> <char> <num>
...
#> 1:        WS001     Westonia    100      99.1       99.5         90.9         99.7
...
#>   1:        AN001    Allanooka 2012-06-19 2024-06-05 -29.06361  114.9972     WA    131
#>   2:        AM001       Amelup 2019-10-09 2024-06-05 -34.27083  118.2685     WA    200
#>   3:        SH002      Babakin 2016-06-22 2024-06-05 -32.12548  118.0041     WA    313
#>   4:           BA  Badgingarra 2008-11-19 2024-06-05 -30.33805  115.5395     WA    284
#>   5:        BP001     Balingup 2014-10-24 2024-06-05 -33.79620  116.0640     WA    227
#>  ---                                                                                  
#> 226:           YS      Yilgarn 2008-11-01 2024-06-05 -31.91562  119.2561     WA    468
#> 227:        YE001    York East 2013-11-08 2024-06-05 -31.83588  116.9211     WA    229
#> 228:        YU001         Yuna 2012-06-21 2024-06-05 -28.33763  114.9898     WA    329
#> 229:        YU002      Yuna NE 2016-03-24 2024-06-05 -28.20032  115.2616     WA    267
#> 230:        YU003   Yuna North 2018-08-08 2024-06-05 -28.12086  114.9626     WA    264
#>                                                                    source status    wmo
#>                                                                    <char> <char> <lgcl>
...
#>   5:        BP001     Balingup 2014-10-24 2024-06-05 -33.79620  116.0640     WA    227
#>  ---                                                                                  
#> 234:           YS      Yilgarn 2008-11-01 2024-06-05 -31.91562  119.2561     WA    468
#> 235:        YE001    York East 2013-11-08 2024-06-05 -31.83588  116.9211     WA    229
#> 236:        YU001         Yuna 2012-06-21 2024-06-05 -28.33763  114.9898     WA    329
#> 237:        YU002      Yuna NE 2016-03-24 2024-06-05 -28.20032  115.2616     WA    267
#> 238:        YU003   Yuna North 2018-08-08 2024-06-05 -28.12086  114.9626     WA    264
