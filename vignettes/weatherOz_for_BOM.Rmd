...
#> Error: Timeout was reached: [ftp.bom.gov.au] Failed to connect to ftp.bom.gov.au port 21 after 60004 ms: Timeout was reached
```
...
#> Error: Timeout was reached: [ftp.bom.gov.au] Failed to connect to ftp.bom.gov.au port 21 after 60005 ms: Timeout was reached
```
...
#> Error in open.connection(con, open = mode): Timeout was reached: [ftp.bom.gov.au] Failed to connect to ftp.bom.gov.au port 21 after 60005 ms: Timeout was reached
```
...
#> Error in curl::curl_download("ftp://ftp.bom.gov.au/anon/home/adfd/spatial/IDR00007.dbf", : Timeout was reached: [] Failed to connect to ftp.bom.gov.au port 21 after 10002 ms: Timeout was reached
head(x)
