---
title: "wrapique Use Case"
author: "Keith Pembleton, Adam H. Sparks and Mark Padgham"
output:
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{wrapique Use Case}
...
## Using {wrapique} with the {WINS} for pulses project
...
loss.
It does this by using the `get_precis_forecast()` function from {wrapique} along with functionality from
[{mailR}](https://CRAN.R-project.org/package=mailR) (Rahul 2015).


```r
install.packages("wrapique")
...
We then use {wrapique} to access the latest précis forecast for Queensland.
