...
To ensure that the data being compared is from the most recent release, reinstall _wrapique_ from CRAN.

```{r diff-codes, eval=FALSE}
...
Save the marine zones' metadata and changes to disk for use in _wrapique_.
