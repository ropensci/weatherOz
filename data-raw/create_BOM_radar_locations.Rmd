...
To ensure that the data being compared is from the most recent release, reinstall {wrapique} from CRAN.
...
Save the radar stations' metadata and changes to disk for use in {wrapique}.
